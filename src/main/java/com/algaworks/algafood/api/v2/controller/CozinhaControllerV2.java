...
public class CozinhaControllerV2 {
	...
	@GetMapping("/por-nome")
	public CollectionModel<CozinhaModelV2> consultarPorNome(@RequestParam("nome") String nome) {
		return cozinhaModelAssembler.toCollectionModel(cozinhaService.consultarTodasPorNome(nome));
	}

	@GetMapping("/unica-por-nome")
	public ResponseEntity<CozinhaModelV2> consultarTodasPorNome(@RequestParam("nome") String nome) {
